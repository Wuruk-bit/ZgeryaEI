...
public class CategoryTests {
    ...
    void createCategory() {
        ...
        Category soda = categoryMethods.createCategory("Газированные напитки", drinksId);
        Category energetics = categoryMethods.createCategory("Энергетические напитки", drinksId);
    ...
    void createProductsInCategories() {
        createCategory();
        // Создаем 3 товара для категории "Пицца"
        ...
        // Создаем 3 товара для категории "Классические роллы"
        ...
        // Создаем 3 товара для категории "Запеченные роллы"
        ...
        // Создаем 3 товара для категории "Сладкие роллы"
        ...
        // Создаем 3 товара для категории "Классические бургеры"
        ...
        // Создаем 3 товара для категории "Острые бургеры"
        ...
        // Создаем 3 товара для категории "Газированные напитки"
        ...
        // Создаем 3 товара для категории "Энергетические напитки"
        ...
        // Создаем 3 товара для категории "Соки"
        ...
        // Создаем 3 товара для категории "Другие"
        Category other = categoryMethods.findByName("Другие");
        Product drink4 = productMethods.createProduct("Минералньая вода", "1", 35.0, other);
        Product drink5 = productMethods.createProduct("Коктейль в аортименте", "2", 120.0, other);
        Product drink6 = productMethods.createProduct("Молочный коктейль", "3", 150.0, other);
        ...
        productMethods.saveAll(List.of(pizza1, pizza2, pizza3, roll1, roll2, roll3,
                ...
                juice1, juice2, juice3, drink4, drink5, drink6));
    }
